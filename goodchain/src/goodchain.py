...
class UserInterface:
    ...
    def logged_in_menu(first_login=False):
        ...
        if first_login:
            ...
            time.sleep(1)
            print("Attempting to sync ledger and pool with other node...")
            try:
                ListeningThread.sync_pool_ledger(conn_threads)
            except Exception as e:
                print("Error syncing pool and ledger: " + str(e))
            print()
        ...
        switch = {
            ...
            '538': UserInterface.syncOnDemand,
    ...
    def transfer_coins():
        ...
        # send the newly created transaction over the network
    ...
    def mine_block():
        ...
        ListeningThread.send_block(conn_threads, new_block)
